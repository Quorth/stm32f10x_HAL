...
# ARM makefile
#
# author: Santi C (@Quorth)
#
# this makefile is based strongly on many examples found in the network
# and on examples from Freddie Chopin, http://www.freddiechopin.info/
#=============================================================================#

#=============================================================================#
# toolchain configuration
#=============================================================================#
TOOLPATH = /usr/local/gcc-arm-none-eabi-5_4-2016q2/bin/
TOOLCHAIN = $(TOOLPATH)arm-none-eabi-
...
CXX_DEFS = -DSTM32F10X_MD_VL -DSTM32F100xB

# C definitions
C_DEFS = -DSTM32F10X_MD_VL -DSTM32F100xB
...
debug:	$(BIN)
	$(TOOLCHAIN)gdb -x debug/gdb.init $(ELF)
